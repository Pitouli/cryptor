...
<ul id="w3c" style="list-style-type : none;" name="w3c">
    <a href="http://validator.w3.org/check?uri=referer"><img src="images/xhtml.png" alt="Valid XHTML 1.0 Transitional" width="80" height="15" border="0" /></a>&nbsp;<img src="images/css.png" alt="Valid CSS" width="80" height="15" />
  </ul> 
<div class="rbtop"><div></div></div>
<div class="rbcontent">
<div id="Accordion1" class="Accordion" >
  <div class="Panel">
    <div class="PanelTab"><div class="rbroundboxtitle"><div class="rbtoptitle"><div></div></div><div class="rbcontenttitle">D&eacute;crypter<div class="rbbottitle"><div></div></div></div></div></div>
    <div class="PanelContent" align="center">
    <form action="decrypte.php" method="post" name="decrypt" id="decrypt">
      <p><label>
       <textarea name="crypte" cols="70" rows="5" class="Textarea">Ne peut d&eacute;coder que du texte commen&ccedil;ant par TWL2.0</textarea>
        </label>
        <br />
        <br />
        <input type="reset" value="Effacer" />
        <input type="submit" value="D&eacute;crypter" /></p>
      
    </form>
    </div>
  </div>
  <div class="Panel">
    <div class="PanelTab"><div class="rbroundboxtitle"><div class="rbtoptitle"><div></div></div><div class="rbcontenttitle">Crypter<div class="rbbottitle"><div></div></div></div></div></div>
    <div class="PanelContent" align="center">
    <form action="crypte.php" method="post" name="clair" id="clair">
	<p>
  	<label>
    <textarea name="clair" cols="70" rows="5" class="Textarea"></textarea>
	</label>
	<br />
    <br />
  	<input type="reset" value="Effacer" />
  ...
  <div class="Panel">
    <div class="PanelTab"><div class="rbroundboxtitle"><div class="rbtoptitle"><div></div></div><div class="rbcontenttitle">Trucs et autres<div class="rbbottitle"><div></div></div></div></div></div>
    <div class="PanelContent">
    <br /><p align="center"><img src="images/blason.png" alt="blason" width="120" height="120" border="0"/></p><br />
<p class="Style3">Remerciements sp&eacute;ciaux &agrave; :</p>
    <ul>
