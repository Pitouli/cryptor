...
<div class="Panel">
  <div class="PanelTab" >R&eacute;sultat du d&eacute;cryptage</div>
  <div class="PanelContent">
	<div align="center"><span class="Style1">
		<?php
            ...
            $decrypte = str_replace("<", "&#60;", $decrypte);
            $decrypte = str_replace("Ú", "<br />", $decrypte);
            echo "$decrypte";
            }
            else
            {
            echo "Ce n'est pas une chaîne cryptée TWL2.0";
            }
        ?></span>
	</div>
  </div>
